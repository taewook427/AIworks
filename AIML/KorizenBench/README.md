...
과제는 난이도에 따라 7개의 Level A, 5개의 Level B, 3개의 Level C로 구성된다.
The tasks are composed of 7 Level A, 5 Level B, and 3 Level C according to difficulty.
...
| 점수 | 내 개인적 해석 |
| :-- | :-- |
| 8 | 좋은 추론력을 가지고 있다. 어려운 강의나 과제 보조용으로 유용해지기 시작. |
| 10 | 2026년 기준, 프론티어 모델이라면 이 정도는 할 것 같다. |
| 12 | Git PR 같이 오류 좀 나도 되돌릴 수 있는 환경이라면 거의 인간 감시 없이 계속 켜두고 쓰는 에이전트에 투입 가능. |
| 14 | 보안같은 고위험 분야에 투입하는 것을 실험할 수 있을 것 같다. |
